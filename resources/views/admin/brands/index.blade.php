                            ...
                            <table class=" table table-bordered table-striped table-hover datatable datatable-brand">
                                ...
                                @foreach($brands as $key => $brand)
                                    <tr data-entry-id="{{ $brand->id }}">
                                       ...
                                       {{-- <td>
                                            @foreach($brand->photos as $key => $photo)
                                        ...
                                        <td>
                                            ...
                                            @can('brand_delete')
                                                <form action="{{ route('admin.brands.destroy', $brand->id) }}" method="POST" onsubmit="return confirm('{{ trans('areYouSure') }}');" style="display: inline-block;">
