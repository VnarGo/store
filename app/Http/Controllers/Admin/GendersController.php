...
class GendersController extends Controller
{
    ...
    {
        abort_if(Gate::denies('gender_access'), 403);
    ...
    {
        abort_if(Gate::denies('gender_create'), 403);

        $genders = Gender::all();

        return view('admin.genders.create',compact('genders'));
    }
    ...
    {
        abort_if(Gate::denies('gender_show'), 403);
